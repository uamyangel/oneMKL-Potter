    ...
    def segment_to_wirelength(self, seg):
        ...
        if seg.which() == 'pip':
            ...
            if is_int_tile is None:
                ...
                # print("Size:", len(self.phys.strList))
                # print("TileName: [%s]"%tile_name)
                # print("TileName: [%s] [%s] [%s] [%s]"%(self.phys.strList[0], self.phys.strList[367022], self.phys.strList[367024], self.phys.strList[6143495]))
            ...
            if is_int_tile:
                ...
                for p in self.pips:
                    if p[0].fullmatch(wire1_name):
                        ...
                        return p[1]
                assert False, "Found unrecognized pip: wire0: " + wire0_name + " wire1: "+wire1_name+" in tile: "+tile_name
                # return 0
            else:
                return 0
        return 0
